                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item active">
                                <Link className="navbar-brand mb-0 h4" to="/">Home |</Link>
                            </li>
                            <li className="nav-item">
                                <Link to={`/LigaSantander`} className="navbar-brand mb-0 h4">Liga Santander |</Link>
                                <Link to={`/Clubs`} className="navbar-brand mb-0 h4">Clubs |</Link>
                            </li>
                            <li className="nav-item" onClick={this.logout}><Link to={`/`} className="navbar-brand mb-0 h4" >Cerrar sesión</Link></li>
