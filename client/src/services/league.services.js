...
export default class Services {
    ...
    getSantanderLeague = () => this.service.get(`https://apiv2.apifootball.com/?action=get_standings&league_id=468&APIkey=4312cac6d96f0cdc803bd9c9065d0c6f7d6e7750302012b19a8790e6d64251a1`)
    ...
    getJornada = selectLiga => this.service.get(`https://apiv2.apifootball.com/?action=get_events&from=2019-08-30&to=2019-09-01&league_id=${selectLiga}&APIkey=4312cac6d96f0cdc803bd9c9065d0c6f7d6e7750302012b19a8790e6d64251a1`)
    getPredictions = selectLiga => this.service.get(`https://apiv2.apifootball.com/?action=get_predictions&from=2019-09-13&to=2019-09-15&league_id=${selectLiga}&APIkey=4312cac6d96f0cdc803bd9c9065d0c6f7d6e7750302012b19a8790e6d64251a1`)
    getPredictionsCarousel = () => this.service.get(`https://apiv2.apifootball.com/?action=get_predictions&from=2019-09-13&to=2019-09-15&league_id=468&APIkey=4312cac6d96f0cdc803bd9c9065d0c6f7d6e7750302012b19a8790e6d64251a1`)
