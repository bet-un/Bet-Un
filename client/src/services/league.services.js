...
export default class Services {
    ...
    getJornada = selectLiga => this.service.get(`https://apiv2.apifootball.com/?action=get_events&from=2019-09-27&to=2019-09-29&league_id=${selectLiga}&APIkey=a9ad72ab2528cdbbc9edddb4c3113a040a7f75cf073e5240d66fd6651f1c4c6f`)
    getPredictions = selectLiga => this.service.get(`https://apiv2.apifootball.com/?action=get_predictions&from=2019-10-04&to=2019-10-06&league_id=${selectLiga}&APIkey=a9ad72ab2528cdbbc9edddb4c3113a040a7f75cf073e5240d66fd6651f1c4c6f`)
    getPredictionsCarousel = () => this.service.get(`https://apiv2.apifootball.com/?action=get_predictions&from=2019-10-04&to=2019-10-06&league_id=468&APIkey=a9ad72ab2528cdbbc9edddb4c3113a040a7f75cf073e5240d66fd6651f1c4c6f`)
